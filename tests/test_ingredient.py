...
class TestIngredient:
    ...
    def test_get_type(self):
        ...
        ingredient = Ingredient("соус", "Майонез", 30.0)
        assert ingredient.get_type() == "соус", "Метод get_type() работает неверно"

    def test_get_price(self):
        
        ingredient = Ingredient("начинка", "Яйцо", 40.0)
        assert ingredient.get_price() == 40.0, "Метод get_price() работает неверно"
